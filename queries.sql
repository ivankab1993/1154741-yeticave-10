...
INSERT INTO lots (author_id, name, category_id, winner_id, start_price, image, date_close, step, description) VALUES 
	("1", "2014 Rossignol District Snowboard", "1", "1", "10999", "img/lot-1.jpg", "2019-12-08", "100", "Легкий маневренный сноуборд, готовый дать жару в любом парке, растопив снег мощным щелчкоми четкими дугами. Стекловолокно Bi-Ax, уложенное в двух направлениях, наделяет этот снаряд отличной гибкостью и отзывчивостью, а симметричная геометрия в сочетании с классическим прогибом кэмбер позволит уверенно держать высокие скорости. А если к концу катального дня сил совсем не останется, просто посмотрите на Вашу доску и улыбнитесь, крутая графика от Шона Кливера еще никого не оставляла равнодушным."),
	("1", "DC Ply Mens 2016/2017 Snowboard", "1", "1", "159999", "img/lot-2.jpg", "2019-11-08", "200", ""),
	("1", "2 Union Contact Pro 2015 года размер L/XL", "2", "1", "8000", "img/lot-3.jpg", "2019-10-08", "300", ""),
	("1", "Ботинки для сноуборда DC Mutiny Charocal", "3", "1", "10999", "img/lot-4.jpg", "2019-09-08", "400", ""),
	("1", "Куртка для сноуборда DC Mutiny Charocal", "4", "1", "7500", "img/lot-5.jpg", "2019-08-25", "500", ""),
	("1", "Маска Oakley Canopy", "5", "1", "5400", "img/lot-6.jpg", "2019-07-25", "600", "");
